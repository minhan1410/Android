...
class CalendarAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CalendarViewHolder {
        ...
        if (days.size > 15) //month view
            layoutParams.height = (parent.height * 0.14).toInt() else  // week view
...
//                compareToDate == 0 ->  holder.parentView.setBackgroundColor( Color.parseColor( "#FFE4B5" ) )
                compareToDate == 0 -> holder.dayOfMonth.setTextColor(Color.parseColor("#FF6666"))
                compareToDate < 0 -> holder.dayOfMonth.setTextColor(Color.parseColor("#A9A9A9"))
